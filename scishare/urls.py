...
urlpatterns = [
    ...
    path('add_study_to_group/',views.add_study_to_group, name='add_study_to_group'),
    path('add_selected_study_to_group/', views.add_selected_study_to_group, name='add_selected_study_to_group'),
    ...
    path('vote/<int:id>/<str:method>/',views.vote,name="vote")
